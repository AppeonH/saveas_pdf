$PBExportHeader$w_treedw_funcs_none.srw
forward
global type w_treedw_funcs_none from window
end type
type cb_8 from commandbutton within w_treedw_funcs_none
end type
type cb_7 from commandbutton within w_treedw_funcs_none
end type
type cb_6 from commandbutton within w_treedw_funcs_none
end type
type sle_msg from multilineedit within w_treedw_funcs_none
end type
type sle_grouplevel from singlelineedit within w_treedw_funcs_none
end type
type sle_row from singlelineedit within w_treedw_funcs_none
end type
type cb_5 from commandbutton within w_treedw_funcs_none
end type
type st_3 from statictext within w_treedw_funcs_none
end type
type cb_4 from commandbutton within w_treedw_funcs_none
end type
type cbx_selectnodebymouse from checkbox within w_treedw_funcs_none
end type
type cbx_eventcancel from checkbox within w_treedw_funcs_none
end type
type cbx_selecttreenode from checkbox within w_treedw_funcs_none
end type
type cb_3 from commandbutton within w_treedw_funcs_none
end type
type cb_2 from commandbutton within w_treedw_funcs_none
end type
type cb_1 from commandbutton within w_treedw_funcs_none
end type
type cb_expandlevel from commandbutton within w_treedw_funcs_none
end type
type cb_collapseallchildren from commandbutton within w_treedw_funcs_none
end type
type cb_expandallchildren from commandbutton within w_treedw_funcs_none
end type
type cb_collapseall from commandbutton within w_treedw_funcs_none
end type
type cb_expandall from commandbutton within w_treedw_funcs_none
end type
type cb_collapse from commandbutton within w_treedw_funcs_none
end type
type cb_expand from commandbutton within w_treedw_funcs_none
end type
type st_2 from statictext within w_treedw_funcs_none
end type
type st_1 from statictext within w_treedw_funcs_none
end type
type cb_collapselevel from commandbutton within w_treedw_funcs_none
end type
type dw_1 from datawindow within w_treedw_funcs_none
end type
end forward
...
global w_treedw_funcs_none w_treedw_funcs_none

type variables
long i_Row,i_GroupLevel
end variables

on w_treedw_funcs_none.create
...
on w_treedw_funcs_none.destroy
destroy(this.cb_8)
destroy(this.cb_7)
destroy(this.cb_6)
