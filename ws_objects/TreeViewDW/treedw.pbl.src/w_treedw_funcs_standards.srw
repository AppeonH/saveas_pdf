$PBExportHeader$w_treedw_funcs_standards.srw
forward
global type w_treedw_funcs_standards from window
end type
type cb_9 from commandbutton within w_treedw_funcs_standards
end type
type cb_8 from commandbutton within w_treedw_funcs_standards
end type
type cb_7 from commandbutton within w_treedw_funcs_standards
end type
type cb_6 from commandbutton within w_treedw_funcs_standards
end type
type sle_msg from multilineedit within w_treedw_funcs_standards
end type
type sle_grouplevel from singlelineedit within w_treedw_funcs_standards
end type
type sle_row from singlelineedit within w_treedw_funcs_standards
end type
type cb_5 from commandbutton within w_treedw_funcs_standards
end type
type st_3 from statictext within w_treedw_funcs_standards
end type
type cb_4 from commandbutton within w_treedw_funcs_standards
end type
type cbx_selectnodebymouse from checkbox within w_treedw_funcs_standards
end type
type cbx_eventcancel from checkbox within w_treedw_funcs_standards
end type
type cbx_selecttreenode from checkbox within w_treedw_funcs_standards
end type
type cb_3 from commandbutton within w_treedw_funcs_standards
end type
type cb_2 from commandbutton within w_treedw_funcs_standards
end type
type cb_1 from commandbutton within w_treedw_funcs_standards
end type
type cb_expandlevel from commandbutton within w_treedw_funcs_standards
end type
type cb_collapseallchildren from commandbutton within w_treedw_funcs_standards
end type
type cb_expandallchildren from commandbutton within w_treedw_funcs_standards
end type
type cb_collapseall from commandbutton within w_treedw_funcs_standards
end type
type cb_expandall from commandbutton within w_treedw_funcs_standards
end type
type cb_collapse from commandbutton within w_treedw_funcs_standards
end type
type cb_expand from commandbutton within w_treedw_funcs_standards
end type
type st_2 from statictext within w_treedw_funcs_standards
end type
type st_1 from statictext within w_treedw_funcs_standards
end type
type cb_collapselevel from commandbutton within w_treedw_funcs_standards
end type
type dw_1 from datawindow within w_treedw_funcs_standards
end type
end forward
...
global w_treedw_funcs_standards w_treedw_funcs_standards

type variables
long i_Row,i_GroupLevel
end variables

on w_treedw_funcs_standards.create
...
on w_treedw_funcs_standards.destroy
destroy(this.cb_9)
destroy(this.cb_8)
destroy(this.cb_7)
destroy(this.cb_6)
...
event clicked;if dw_1.isselected(i_row) then
	sle_msg.text= string(i_row) +" is selected"+"~r~n"+sle_msg.text
else
	sle_msg.text= string(i_row) +" is unselected"+"~r~n"+sle_msg.text
end if
end event
...
sle_msg.text="Rowfocuschanging:OldRow:NewRow "+string(currentrow)+":"+string(newrow)+"~r~n"+sle_msg.text
end event

event clicked;sle_msg.text="Clicked: band "+this.GetBandAtPointer( )+"~r~n"+sle_msg.text
end event

event editchanged;sle_msg.text="EditChanged:  "+string(row)+"~r~n"+sle_msg.text
end event

event collapsing;sle_msg.text= "Collapsing:Row:GroupLevel "+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
...
event collapsed;
sle_msg.text= "Collapsed:Row:GroupLevel "+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
if cbx_eventcancel.checked then
	return 1
else   
	return 0
...
event treenodeselecting;sle_msg.text="treenodeselecting:Row:GroupLevel "+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
if cbx_eventcancel.checked then
	return 1
else
	return 0
...
event treenodeselected;sle_msg.text="treenodeselected:Row:GroupLevel "+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
if cbx_eventcancel.checked then
	return 1
else
	return 0
...
sle_msg.text= "Expanding:Row:GroupLevel"+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
if cbx_eventcancel.checked then
	return 1
else
	return 0 
...
sle_msg.text= "Expanded:Row:GroupLevel "+string(row)+":"+string(grouplevel)+"~r~n"+sle_msg.text
end event
