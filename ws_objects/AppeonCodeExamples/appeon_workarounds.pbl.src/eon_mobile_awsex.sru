...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Description: 
//               Sets the duration (in milliseconds) for a press before it is recognized as a long press. Once this long press duration is reached, the keyboard
//				will be brought up to display (by default, the keyboard pops up only when the user taps twice in the field of the DataWindow).
//               Supported on mobile client only.  	
// 
// Arguments:
//		value    long    al_interval
//					1 - Sets the duration in milliseconds. If it is set to a value smaller than 500 milliseconds, then 550 milliseconds will be used, because 500
//						 milliseconds is already used as the duration for the DataWindow drag & drop event.If this function is not called, the default value that
