$PBExportHeader$w_importfuc_new.srw
$PBExportComments$DW.ImportFile, DW.ImportString，DW. ImportClipboard Function test.
forward
global type w_importfuc_new from window
end type
type dw_1 from datawindow within w_importfuc_new
end type
type st_4 from statictext within w_importfuc_new
end type
type st_2 from statictext within w_importfuc_new
end type
type cb_2 from commandbutton within w_importfuc_new
end type
type cb_clear from commandbutton within w_importfuc_new
end type
type st_tip from singlelineedit within w_importfuc_new
end type
type cb_1 from commandbutton within w_importfuc_new
end type
type lb_functionparm from listbox within w_importfuc_new
end type
type lb_functionname from listbox within w_importfuc_new
end type
type sle_functionparm from singlelineedit within w_importfuc_new
end type
type st_1 from statictext within w_importfuc_new
end type
type gb_1 from groupbox within w_importfuc_new
end type
type gb_4 from groupbox within w_importfuc_new
end type
type gb_2 from groupbox within w_importfuc_new
end type
end forward
...
global w_importfuc_new w_importfuc_new
...
Choose Case lb_functionname.SelectedItem()
	Case 'ImportFile'
		...
		strexevalue = String(dw_1.ImportFile(lnv_file.IS_FilePath + 'ImportFile.txt'))
...
if lb_functionname.SelectedItem()="ImportString" or  lb_functionname.SelectedItem()="ImportFile" then
...
//		sle_functionparm.Enabled = False
		lb_functionparm.additem('ImportFile.txt')
