...
forward
global type w_shared_dw_graph from window
end type
type cb_5 from commandbutton within w_shared_dw_graph
end type
type cb_4 from commandbutton within w_shared_dw_graph
end type
...
string title = "Graphs & Shared DataWindow"
...
event clicked;dw_3dcolumn.saveas( )
end event
