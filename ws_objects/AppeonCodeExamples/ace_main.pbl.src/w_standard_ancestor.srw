$PBExportHeader$w_standard_ancestor.srw
$PBExportComments$Ancestor window for standard windows
forward
global type w_standard_ancestor from window
end type
type tab_1 from tab within w_standard_ancestor
end type
...
type cb_2 from commandbutton within w_standard_ancestor
end type
type cb_1 from commandbutton within w_standard_ancestor
end type
type st_tip from statictext within w_standard_ancestor
end type
type gb_4 from groupbox within w_standard_ancestor
end type
type gb_1 from groupbox within w_standard_ancestor
end type
end forward
...
global w_standard_ancestor w_standard_ancestor
...
Choose Case ls_data
	Case 'BackColor'
		ls_type = 'Color'
	Case  'Checked','Border','Haslines','hasbuttons','RightToLeft'	
		ls_type = 'boolean'
	Case  'Enabled'
		ls_type = 'boolean'
	Case  'Height'
...
on w_standard_ancestor.destroy
destroy(this.tab_1)
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.st_tip)
