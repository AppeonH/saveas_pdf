...
event clicked;call super::clicked;dw_2.object.p_2.filename = 'login_btn.jpg'

dw_2.object.p_2.width = 1000
dw_2.object.p_2.height = 200

of_saveas(dw_2,cbx_4.checked)
end event
...
event doubleclicked;integer series, datapoint
grObjectType clickedtype
integer percentage
string ls_type
percentage = 60

ls_type = this.Object.gr_1.GraphType

if ls_type <> '13' and ls_type <> '17' then return

clickedtype = This.ObjectAtPointer("gr_1", series, datapoint)

IF (series > 0 and datapoint > 0) THEN       
	This.SetDataPieExplode("gr_1",series, datapoint, percentage)
END IF
end event
