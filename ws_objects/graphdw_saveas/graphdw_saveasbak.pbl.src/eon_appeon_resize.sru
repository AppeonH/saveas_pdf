...
global type eon_appeon_resize from nonvisualobject autoinstantiate
end type
...
public subroutine of_fontresize (boolean ab_resize, integer ai_type);
//ai_type - 1 - Resizes proportionally with height;
//2 - Resizes proportionally with width; 
//3 - Resizes with height or width whichever has the smaller change in proportion; 
//4: Resizes with height or width whichever has the bigger change in proportion.

ib_fontresize = ab_resize

ii_fonttype = ai_type
end subroutine

public subroutine of_zoom (boolean ab_zoom, integer ai_type);//ai_type - 1 - Resizes proportionally with height;
//2 - Resizes proportionally with width; 
//3 - Resizes with height or width whichever has the smaller change in proportion; 
//4: Resizes with height or width whichever has the bigger change in proportion.
...
of_zoom(ab_zoom,ai_type,3)
end subroutine

public subroutine of_resize (userobject au_uo, integer ai_newwidth, integer ai_newheight, boolean ab_recursion);//Resizes a control according to the registered information.
Integer li_controls,i
int  li_font
...
public subroutine of_resize (window aw_window, integer ai_newwidth, integer ai_newheight, boolean ab_recursion);//Resizes a control according to the registered information.
Integer li_controls,i
int  li_font
String ls_xbl,ls_ybl,ls_wbl,ls_hbl,ls_width,ls_height,ls_textsize,ls_flag
decimal{6}  ld_rate
...
adw.resize(ai_newwidth,ai_newheight)
if ib_stopall then return
if ib_zoom then
	choose case ii_type
			case 1
...
public subroutine of_setflag (windowobject awo, string as_flag);//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//The flag of the object or control. The value of flag is composed of 4 digits, by default it is "1111".
