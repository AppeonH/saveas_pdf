...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=EAS Demo DB V2017 Unicode;UID=dba;PWD=sql'")
...
//	as_logpass		= "sql"
//	as_server		= ""
//	as_dbparm		= "Driver='com.sybase.jdbc3.jdbc.SybDriver',URL='jdbc:sybase:Tds:192.0.3.202:2690/appeon_ykg'"
//	as_lock			= ""
//	as_autocommit	= "false"
